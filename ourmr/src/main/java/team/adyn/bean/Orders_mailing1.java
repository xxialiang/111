...
public class Orders_mailing1 implements Writable, WritableComparable<Orders_mailing1>, DBWritable {
	...
	public Orders_mailing1(Integer lid, String oid, int odid, int mdid, int mid, String cname, int cid, int pid,
	...
	public int compareTo(Orders_mailing1 om1) {
		// TODO Auto-generated method stub
		return this.lid - om1.lid;
	}
