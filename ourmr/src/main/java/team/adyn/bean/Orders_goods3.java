...
public class Orders_goods3 implements Writable, WritableComparable<Orders_goods3>, DBWritable {
	...
	public Orders_goods3(Integer lid, String oid, int odid, int mdid, int mid, String cname, int cid, int pid, int gid,
			String gname) {
		super();
		this.lid = lid;
		this.oid = oid;
	...
	public int compareTo(Orders_goods3 og3) {
		// TODO Auto-generated method stub
		return this.lid - og3.lid;
	}
