...
public class Orders_goods2 implements Writable, WritableComparable<Orders_goods2>, DBWritable {
	...
	public Orders_goods2(Integer lid, String oid, int odid, int mdid, int mid, String cname, int cid, int pid, int gid,
			String gname) {
		super();
		this.lid = lid;
		this.oid = oid;
	...
	public int compareTo(Orders_goods2 og2) {
		// TODO Auto-generated method stub
		return this.lid - og2.lid;
	}
