...
public class Orders_mailing2 implements Writable, WritableComparable<Orders_mailing2>, DBWritable {
	...
	public Orders_mailing2(Integer lid, String oid, int odid, int mdid, int mid, String cname, int cid, int pid,
	...
	public int compareTo(Orders_mailing2 om2) {
		// TODO Auto-generated method stub
		return this.lid - om2.lid;
	}
