...
public class Orders_goods1 implements Writable, WritableComparable<Orders_goods1>, DBWritable {
	...
	public Orders_goods1(Integer lid, String oid, int odid, int mdid, int mid, String cname, int cid, int pid, int gid,
			String gname) {
		super();
		this.lid = lid;
		this.oid = oid;
	...
	public int compareTo(Orders_goods1 og1) {
		// TODO Auto-generated method stub
		return this.lid - og1.lid;
	}
