...
public class Orders_mailing3 implements Writable, WritableComparable<Orders_mailing3>, DBWritable {
	...
	public Orders_mailing3(Integer lid, String oid, int odid, int mdid, int mid, String cname, int cid, int pid,
	...
	public int compareTo(Orders_mailing3 om3) {
		// TODO Auto-generated method stub
		return this.lid - om3.lid;
	}
