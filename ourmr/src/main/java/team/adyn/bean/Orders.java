...
public class Orders implements Writable, WritableComparable<Orders>, DBWritable {
	...
	public Orders(Integer lid, String oid, int odid, int mdid, int mid, String cname, int cid, int pid, int gid,
			String gname) {
		super();
		this.lid = lid;
		this.oid = oid;
