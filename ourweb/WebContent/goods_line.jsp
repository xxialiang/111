...
<div id="goods_line" style="width: 1200px; height: 650px"></div>
<script>
	var gChart3 = echarts.init(document.getElementById("goods_line"));
	var url = "Goods_line";
