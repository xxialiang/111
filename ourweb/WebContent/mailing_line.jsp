...
<div id="mailing_line" style="width: 1200px; height: 650px"></div>
<script>
	var mChart3 = echarts.init(document.getElementById("mailing_line"));
	var url = "Mailing_line";
